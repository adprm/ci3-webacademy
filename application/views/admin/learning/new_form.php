		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<form action="<?php echo site_url('admin/learnings/add') ?>" method="post" enctype="multipart/form-data" >

							<div class="form-group">
                                <!-- input title -->
								<label for="learning_title">Title*</label>
								<input class="form-control <?php echo form_error('learning_title') ? 'is-invalid':'' ?>"
								 type="text" name="learning_title" placeholder="Learning title" />
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('learning_desk') ? 'is-invalid':'' ?>"
								 name="learning_desk" placeholder="Learning description..."></textarea>
								<div class="invalid-feedback">
