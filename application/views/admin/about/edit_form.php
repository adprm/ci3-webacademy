				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							oleh controller tempat view ini digunakan. Yakni index.php/admin/abouts/edit/ID --->
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('about_title') ? 'is-invalid':'' ?>"
								 type="text" name="about_title" placeholder="About title" value="<?php echo $about->about_title ?>" />
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_image" value="<?php echo $about->about_image ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('about_desk') ? 'is-invalid':'' ?>"
								 name="about_desk" placeholder="About description..."><?php echo $about->about_desk ?></textarea>
								<div class="invalid-feedback">
